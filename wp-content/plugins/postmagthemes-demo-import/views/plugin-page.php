...
<div class="pmdi  wrap  about-wrap">
	...
	if ( ini_get( 'safe_mode' ) ) {
		printf(
			esc_html__( '%sWarning: your server is using %sPHP safe mode%s. This means that you might experience server timeout errors.%s', 'pt-pmdi' ),
	...
	<div class="pmdi__intro-text">
		...
		<?php if ( ! empty( $this->import_files ) ) : ?>
			<?php if ( empty( $_GET['import-mode'] ) || 'manual' !== $_GET['import-mode'] ) : ?>
				<a href="<?php echo esc_url( add_query_arg( array( 'page' => $this->plugin_page_setup['menu_slug'], 'import-mode' => 'manual' ), admin_url( $this->plugin_page_setup['parent_slug'] ) ) ); ?>" class="pmdi__import-mode-switch"><?php esc_html_e( 'Switch to manual import!', 'pt-pmdi' ); ?></a>
			<?php else : ?>
	...
	<?php elseif ( 1 === count( $predefined_themes ) ) : ?>
		...
		<div class="pmdi__demo-import-notice  js-pmdi-demo-import-notice"><?php
