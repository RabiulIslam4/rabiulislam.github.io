  ...
  private $plugin_page_setup = array();
	...
	private function final_response() {
		...
		if ( empty( $this->frontend_error_messages ) ) {
			...
			if ( ! apply_filters( 'pt-pmdi/disable_pt_branding', false ) ) {
				$twitter_status = esc_html__( 'Just used PostmagThemes Demo Import plugin and it was awesome! Thanks @PostmagThemes! #PMDI https://www.postmagthemes.com/', 'pt-pmdi' );

				$response['message'] .= sprintf(
					__( '%1$s%6$sWasn\'t this a great PostmagThemes Demo Import experience?%7$s Created and maintained by %3$PostmagThemes%4$s. %2$s%5$sClick to Tweet!%4$s%8$s', 'pt-pmdi' ),
					'<div class="notice  notice-info"><p>',
					'<br>',
					'<strong><a href="https://www.postmagthemes.com/" target="_blank">',
					'</a></strong>',
