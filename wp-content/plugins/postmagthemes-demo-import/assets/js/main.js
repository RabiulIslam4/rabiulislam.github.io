jQuery( function ( $ ) {
	 ...
	 */
	$( '.js-pmdi-import-data' ).on( 'click', function () {
	 ...
	 */
	$( '.js-pmdi-gl-import-data' ).on( 'click', function () {
	...
	(function () {
		...
		$( '.js-pmdi-nav-link' ).on( 'click', function( event ) {
	 ...
	 */
	$( '.js-pmdi-gl-search' ).on( 'keyup', function( event ) {
