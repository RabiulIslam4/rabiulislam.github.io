...
if (!class_exists('hcode_custom_menu_widget')) {
	class hcode_custom_menu_widget extends WP_Widget {
		...
		function __construct() {
			...
			esc_html__('H-Code Custom Menu', 'hcode-addons'),
			array( 'description' => esc_html__( 'Add a custom menu to your sidebar.', 'hcode-addons' ), ) // Args
			);
		}
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'custom_menu' ); ?>"><?php esc_html_e( 'Select Menu :', 'hcode-addons' ); ?></label> 
				<?php
