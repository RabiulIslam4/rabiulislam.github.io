...
if ( ! class_exists( 'WPOP_Demos' ) ) {
	...
	class WPOP_Demos {
		...
		public function __construct() {
            ...
            //Demo content URL
			$this->demo_content_url = 'https://raw.githubusercontent.com/wpoperation/'.get_stylesheet().'-demo-data/master/';
		...
		public static function get_demos_data() {
			...
			// Return
			$file= 'https://raw.githubusercontent.com/wpoperation/'.get_stylesheet().'-demo-data/master/config.json';
