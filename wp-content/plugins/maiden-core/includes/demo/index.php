...
/**
 * maiden_Import_Demo class
 */
class maiden_Import_Demo {
	...
	*/
	...
	public function enqueue_script(){
		...
		wp_enqueue_style( 'maiden_demo', $this->demo_folder_uri . 'css/demo_install.css');
		wp_enqueue_script( 'maiden_demo_script', $this->demo_folder_uri . 'js/demo_install.js', array( 'jquery' ), '20160715', true );

		wp_localize_script( 'maiden_demo_script', 'maiden_demo', array(
			'ajaxurl' => admin_url('admin-ajax.php'),
			'wpnonce' => wp_create_nonce('maiden_install_demo')
		) );
