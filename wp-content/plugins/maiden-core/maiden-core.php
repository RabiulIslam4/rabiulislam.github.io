...
if ( ! class_exists( 'Maiden_Core' ) ) {
	...
	class Maiden_Core {
		...
		public function __construct() {
			...
			add_action( 'admin_init', array( $this, 'maiden_load_shortcodes' ) );
			add_action( 'wp', array( $this, 'maiden_load_shortcodes' ) );

		}

		/* Load Shortcodes */
		public function maiden_load_shortcodes() {

			if ( class_exists( 'Vc_Manager' ) ) {
				foreach ( glob( EF_ROOT . '/' . 'shortcodes/maiden_*.php' ) as $shortcode ) {
		...
		public static function maiden_plugin_dir() {
