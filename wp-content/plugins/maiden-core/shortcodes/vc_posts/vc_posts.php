...
class WPBakeryShortCode_vc_projects_posts extends WPBakeryShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		extract( shortcode_atts( array(
			...
			'filter' 	   => 'disable',
			'enable_load_more' => '',
			'total_columns' => 'maiden_count_col1',
		), $atts ) );
		...
		$class_wrap = 'maiden_' . $templates . ' ' . $total_columns;
		...
		if ( !empty($enable_load_more) && $posts_per_page < $count_posts->publish ) {
			?>
			<div class="maiden-purchase section">
				<div class="section-content">
					<div class="container">
						<div class="col-md-12 col-sm-12 col-12 text-center">
							<button class="btn load-more"><?php esc_html_e('Load More', 'maiden'); ?></button>
						</div>
					</div>
				</div>
			</div>
