...
/** Necessary Constants **/
defined( 'WPOPEA_VERSION' ) or define( 'WPOPEA_VERSION', '1.1.0' ); //plugin version
...
if(!class_exists('Wpop_El_Addons')) :
	...
	class Wpop_El_Addons {
		...
		function wpopea_elements_register(){
            require_once WPOPEA_PATH.'elements/opstore/site-logo.php';
            require_once WPOPEA_PATH.'elements/opstore/advanced-menu.php';
            require_once WPOPEA_PATH.'elements/opstore/header-icons.php';
            require_once WPOPEA_PATH.'elements/opstore/normal-search.php';
            require_once WPOPEA_PATH.'elements/opstore/news-ticker.php';
			require_once WPOPEA_PATH.'elements/opstore/opstore-blog.php';
			require_once WPOPEA_PATH.'elements/opstore/tiled-posts.php';
			if(class_exists('woocommerce')){
				require_once WPOPEA_PATH.'elements/opstore/category-dropdown.php';
